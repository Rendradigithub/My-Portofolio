...
export const GitlabIcon = (props: IconType) => (
  <svg viewBox="0 0 512 512" fill="currentColor" className={props.className}>
    <path d="M494.1 295.6l-27.1-83.2L413.7 48.6c-2.5-7.7-13.4-7.7-15.9 0L344.6 212.4H167.4L114.2 48.6c-2.5-7.7-13.4-7.7-15.9 0L45 212.4l-27.1 83.2a16 16 0 0 0 5.8 17.9L256 480l232.4-166.5a16 16 0 0 0 5.7-17.9z" />
  </svg>
);

export const InstagramIcon = (props: IconType) => (
  <svg viewBox="0 0 448 512" fill="currentColor" className={props.className}>
    <path d="M224 202.66A53.34 53.34 0 1 0 277.34 256 53.38 53.38 0 0 0 224 202.66Zm124.71-41a54 54 0 0 0-30.16-30.16C293.19 124.5 224 124.5 224 124.5s-69.19 0-94.55 7.99a54 54 0 0 0-30.16 30.16C91.3 187.81 91.3 256 91.3 256s0 68.19 7.99 94.55a54 54 0 0 0 30.16 30.16C154.81 387.5 224 387.5 224 387.5s69.19 0 94.55-7.99a54 54 0 0 0 30.16-30.16C356.7 324.19 356.7 256 356.7 256s0-68.19-7.99-94.55ZM224 338a82 82 0 1 1 82-82A81.9 81.9 0 0 1 224 338Zm85.38-148.3a19.14 19.14 0 1 1 19.14-19.14 19.1 19.1 0 0 1-19.14 19.14ZM400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h352a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48Z" />
  </svg>
);
