        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              Aku mengubah konsep liar menjadi nyata dengan coding. Dan sekarang saya sedang terus berkembang untuk mempelajari segalanya tentang teknologi.
            </p>
          </FadeUp>
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              ...
              saya, terdapat produk hasil Reactjs, Nextjs, Nodejs, Javascript
              dan web development yang saya kembangkan.
            </p>
          </FadeUp>
          <FadeRight
            key="hero-location"
