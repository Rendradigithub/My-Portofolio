          ...
          <AnimatePresence>
            ...
            <FadeUp key="description" duration={0.6} delay={0.2}>
              <div className="mt-8 max-w-3xl text-base font-semibold text-zinc-900 dark:text-zinc-200 sm:text-base md:text-xl">
                Saya adalah seorang software developer berpengalaman di pengembangan
                end-to-end, user-focused web aplikasi. Pemula di {" "}
                <span className="font-semibold text-accent">Java</span>, dan{" "}
                <span className="font-semibold text-accent">Laravel</span>.{" "}
                <span className="font-semibold text-accent"></span> Dan{" "}
                 Familiar di {" "}
                ...
                <span className="font-semibold text-accent"></span> Dan Tingkat lanjut di{" "}
